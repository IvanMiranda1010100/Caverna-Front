// src/components/ComicItem.js
import React from 'react';

function ComicCard({ comic }) {
  return (
    <>
    <div className="relative flex flex-col bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden max-w-xs md:max-w-sm lg:max-w-md">
      <div className="absolute inset-0 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 p-1 rounded-lg"></div>
      <div className="relative flex flex-col bg-white dark:bg-gray-800 rounded-lg overflow-hidden">
        ...
        <div className="p-4 flex flex-col justify-between flex-1">
          <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-800 dark:text-gray-100">{comic.title}</h2>
